	...
	<view class="delivery">
		<view class="state">
			<view>
				...
				<view class="total-price">订单金额 : 129 元 + 1296 积分</view>
			</view>
			<image class="delivery-img" src="../../static/order/delivery2.png" mode=""></image>
		</view>
		...
		<view class="order-center">
			...
			<view class="center-right">
				...
				<view class="detail">
					<view class="detail-price">129 元 + 1296 积分</view>
		...
		<view class="content-center">
			...
			<view class="total">
				...
				<view class="total-price-right">129 元 + 1296 积分</view>
			</view>
		</view>
		<view class="order-bottom">
			<view class="copy">
				<view>订单编号：SH20200214578963548</view>
				<view class="copy-text" @click="copy()">复制</view>
			</view>
