<template>
  <view class="container">
	...
	<!-- 拍卖 -->
<!-- 	<view class="sou">
		<u-search border-color='#000000' height='60' @custom='search' placeholder="搜一搜你喜欢的作品" v-model="keyword"></u-search>
	</view> -->
...
<script>
	...
	export default {
		...
		methods: {
			getGoodsCate() {
				var self = this;
				self.$http.post(service.api.main.goodsList, {
					type:3,
					page:self.page,
					...
					// list.forEach(item =>{
					// 	if(item.is_leakarea == 0){
					// 		self.goodsCate.push(item);
					// 	}
					// })
				});
			},
