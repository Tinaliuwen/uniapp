  ...
  <view class="container">
	...
	<view class="goods-section">
		...
		<view class="goods-list u-f-jsb u-f-fw">
			<view class="goods-item" @click="jumper(`/pages/category/newpleity?id=${item.id}&is_identific=${item.is_identific}`)" v-for="(item,index) in goodsCate" :key="index">
...
<script>
	...
	export default {
		...
		methods: {
			getGoodsCate() {
				var self = this;
				self.$http.get(service.api.main.getNewGoodList,{
					page:self.page
				}).then(function(res) {
