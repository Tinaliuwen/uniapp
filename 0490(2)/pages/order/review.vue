<template>
	<view class="review">
		<view class="state">
			<view class="success">退款成功</view>
			<view class="total-price">订单金额 : 129 元</view>
		</view>
		<view class="content">
			<view class="center">
		...
		<view class="order-bottom">
			<view>申请原因：不想要了</view>
			<view class="time">申请时间：2020-11-22 11:46</view>
			<view class="time">退款编号：SH20200214578963548</view>
		</view>
	</view>
</template>
